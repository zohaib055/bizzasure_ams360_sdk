...
METHOD = 'policy_transaction_premium_get_list_for_policy'
...
class TestPolicyTransactionPremiumGetListForPolicy(unittest.TestCase):
    ...
    def test_policy_transaction_premium_get_list_for_policy(self) -> None:
