...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'common_suspense_get_list_by_entity_id.json'
...
class TestCommonSuspenseGetListByEntityId(unittest.TestCase):
    ...
    def test_common_suspense_get_list_by_entity_id(self) -> None:
