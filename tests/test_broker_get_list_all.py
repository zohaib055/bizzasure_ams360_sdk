...
METHOD = 'broker_get_list_all'
LOG_PATH = ROOT_DIR / "log.txt"
RESPONSE_PATH = ROOT_DIR / "demos" / "broker_get_list_all.json"
...
class TestBrokerGetListAll(unittest.TestCase):
    ...
    def test_broker_get_list_all(self) -> None:
        ...
        # TODO: Keep response snapshots updated when demo payloads change.
