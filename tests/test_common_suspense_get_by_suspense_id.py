...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'common_suspense_get_by_suspense_id.json'
...
class TestCommonSuspenseGetBySuspenseId(unittest.TestCase):
    ...
    def test_common_suspense_get_by_suspense_id(self) -> None:
