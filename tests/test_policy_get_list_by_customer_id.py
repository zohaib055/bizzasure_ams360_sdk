...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'policy_get_list_by_customer_id.json'
...
class TestPolicyGetListByCustomerId(unittest.TestCase):
    ...
    def test_policy_get_list_by_customer_id(self) -> None:
