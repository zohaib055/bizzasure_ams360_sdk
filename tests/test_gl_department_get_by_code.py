...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'gl_department_get_by_code.json'
...
class TestGlDepartmentGetByCode(unittest.TestCase):
    ...
    def test_gl_department_get_by_code(self) -> None:
