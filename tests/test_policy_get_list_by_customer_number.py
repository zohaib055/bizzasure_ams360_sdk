...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'policy_get_list_by_customer_number.json'
...
class TestPolicyGetListByCustomerNumber(unittest.TestCase):
    ...
    def test_policy_get_list_by_customer_number(self) -> None:
