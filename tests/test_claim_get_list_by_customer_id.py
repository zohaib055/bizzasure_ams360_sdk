...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'claim_get_list_by_customer_id.json'
...
class TestClaimGetListByCustomerId(unittest.TestCase):
    ...
    def test_claim_get_list_by_customer_id(self) -> None:
