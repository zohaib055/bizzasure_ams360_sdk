...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'customer_suspense_get_list_by_customer_id.json'
...
class TestCustomerSuspenseGetListByCustomerId(unittest.TestCase):
    ...
    def test_customer_suspense_get_list_by_customer_id(self) -> None:
