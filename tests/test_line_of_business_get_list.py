...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'line_of_business_get_list.json'
...
class TestLineOfBusinessGetList(unittest.TestCase):
    ...
    def test_line_of_business_get_list(self) -> None:
