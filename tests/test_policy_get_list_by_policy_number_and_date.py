...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'policy_get_list_by_policy_number_and_date.json'
...
class TestPolicyGetListByPolicyNumberAndDate(unittest.TestCase):
    ...
    def test_policy_get_list_by_policy_number_and_date(self) -> None:
