...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'policy_get_list_by_policy_number.json'
...
class TestPolicyGetListByPolicyNumber(unittest.TestCase):
    ...
    def test_policy_get_list_by_policy_number(self) -> None:
