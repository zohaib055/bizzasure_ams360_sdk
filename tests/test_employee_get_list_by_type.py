...
PAYLOAD_PATH = ROOT_DIR / 'demos' / 'employee_get_list_by_type.json'
...
class TestEmployeeGetListByType(unittest.TestCase):
    ...
    def test_employee_get_list_by_type(self) -> None:
